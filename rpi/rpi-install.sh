...
docker run --rm -v /tmp/:/reports/:rw pensivesecurity/rpi-scanner:latest python3 -u scan.py "$ip_subnet" --debug --format="PDF" --output rpi-openvas-report.pdf --profile="Full and fast"
